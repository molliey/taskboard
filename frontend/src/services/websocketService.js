  ...
  handleMessage(data) {
    switch (data.type) {
      ...
      case 'project_created':
        this.notifyListeners('project_created', data.payload);
        break;
      case 'project_updated':
        this.notifyListeners('project_updated', data.payload);
        break;
      case 'project_deleted':
        this.notifyListeners('project_deleted', data.payload);
        break;
      case 'member_added':
        this.notifyListeners('member_added', data.payload);
        break;
      case 'member_removed':
